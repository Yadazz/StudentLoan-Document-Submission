...
const ProfileScreen = ({ navigation }) => {
  ...
  const renderField = (
    ...
    const displayValue =
      inputType === "date" && value instanceof Timestamp
    ...
    return (
      <View
        style={[
          ...
          isLongText && styles.fieldContainerStacked,
        ]}
      >
        ...
        {isEditing && inputType === "date" ? (
          <>
            <TouchableOpacity
              style={[styles.fieldValueContainer, { borderColor: "#2563eb" }]}
          ...
          <TouchableOpacity
            style={[
              ...
              !value && styles.fieldValueContainerStacked,
            ]}
            onPress={handlePress}
            activeOpacity={0.7}
          >
        ...
        {isExpanded && (
          <Animated.View style={styles.sectionContent}>
            <View style={styles.infoGrid}>
              ...
              {sectionPath === "guardian_info" &&
                renderField(
                  "ความสัมพันธ์",
                  info.guardian_relation,
                  sectionPath,
                  "guardian_relation",
                  "people-outline"
                )}
            ...
            {renderAddress(
              info.address_perm,
              `${sectionPath}.address_perm`,
              "ที่อยู่ตามทะเบียนบ้าน",
              "home"
            )}
            {renderAddress(
              info.address_current,
              `${sectionPath}.address_current`,
              "ที่อยู่ปัจจุบัน",
              "location"
            )}
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View
        style={[styles.saveOverlay, { opacity: saveAnimation }]}
        pointerEvents="none"
      >
      ...
      >
        ...
        {/* Family Information */}
        {renderPersonInfo(
          userData.father_info,
          "ข้อมูลบิดา",
          "father_info",
          "man-outline"
        )}
        {renderPersonInfo(
          userData.mother_info,
          "ข้อมูลมารดา",
          "mother_info",
          "woman-outline"
        )}
