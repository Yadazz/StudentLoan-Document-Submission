...
async function fillPdf(userData, existingPdfBytes, fontBytes) {
  ...
  //   // เพิ่มตำแหน่งสำหรับที่อยู่ตามทะเบียนบ้าน
     ...
     firstPage.drawText(userData.address_current.moo || "-", { x: 208.8, y: 343.44, size: 12, font: customFont });
     ...
     firstPage.drawText(userData.address_perm.zipcode || "-", { x: 119.52, y: 280, size: 12, font: customFont });
      firstPage.drawText(userData.address_perm.birth_date || "-", { x: 228.24, y: 298, size: 12, font: customFont });
     firstPage.drawText(userData.address_perm.birthdate || "-", { x: 328.64, y: 298, size: 12, font: customFont });
     firstPage.drawText(userData.address_perm.createdAt || "-", { x: 444.96, y: 298, size: 12, font: customFont });
     firstPage.drawText(userData.address_perm.email || "-", { x: 119.52, y: 280, size: 12, font: customFont });
   }
